...
jogo1= Jogo('Cabal', 'MMORPG', 'PC')
jogo2= Jogo('PES 2023', 'Esportes', 'PS5')
...
usuario1 = Usuario('Matheus Sales', 'salesmts', '159753')
usuario2 = Usuario('Carolina Sales', 'caahsales', '123456')
usuario3 = Usuario('Mikaelly Sales', 'mkysales', '12345678')

usuarios = { usuario1.nickname : usuario1, usuario2.nickname : usuario2, usuario3.nickname : usuario3 }

app = Flask(__name__)
app.secret_key = 'carolina'
